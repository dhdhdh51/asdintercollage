...
function handle_install_step() {
    ...
    try {
        ...
        // 6. Storage link (skip if already linked)
        ...
        if (str_contains($envContent, 'APP_KEY=base64:CHANGE_ME') || str_contains($envContent, 'APP_KEY=')) {
            ob_start();
...
PAYU_SUCCESS_URL="\${APP_URL}/payment/success"
PAYU_FAILURE_URL="\${APP_URL}/payment/failure"
ENV;
